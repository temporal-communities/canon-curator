...
from canon_curator.wiring import build_geodata_enricher, build_authordata_enricher, build_readerstats_enricher, build_popularity_enricher
from canon_curator.enrich.enrichers import GeodataEnricher, AuthordataEnricher, PopularityEnricher, ReaderstatEnricher
...
def test_build_geodata_enricher_invalid(bad_config):
    with pytest.raises(ValueError, match="goodreads_readerstats is not a valid strategy for GeodataEnricher."):
